...
globalkeys = my_table.join(
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey, "Shift" }, "x", function () awful.spawn(" betterlockscreen -l dim " ) end,
    		  {description = "lockscreen", group = "awesome"}),
    awful.key({ modkey, "Shift" }, "q", function () awful.spawn(" betterlockscreen -l dim " ) end,
              {description = "hybrid-lockscreen", group = "awesome"}),
    awful.key({ modkey, "Shift" }, "q", function () awful.spawn(" systemctl suspend " ) end,
              {description = "hybrid-lockscreen", group = "awesome"}),
