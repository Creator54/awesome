...
mytextclock = wibox.widget.textclock(" %a %b %d, %r ", 1)
...
globalkeys =
	...
	awful.key(
		...
		"l",
		function()
			awful.spawn.with_shell('betterlockscreen -l -tf "%I:%M %p" -t "Life is a Mystery"')
		end,
	...
	awful.key(
		...
		"i",
		function()
			awful.spawn(editor_cmd .. " .config/awesome/rc.lua")
		end,
	...
	awful.key(
		...
		"k",
		function()
			awful.spawn.with_shell("screenkey --no-systray -t 0.4 --opacity 0.0")
		end,
	...
	awful.key(
		...
		"a",
		function()
			awful.spawn.with_shell("pkill screenkey")
		end,
	...
	awful.key(
		...
		"n",
		function()
			awful.spawn(terminal .. " -e nnn -cEFnQrux")
		end,
	...
	awful.key(
		...
		"r",
		function()
			awful.util.spawn("rofi -threads 0 -sort -show drun -show-icons ")
		end,
